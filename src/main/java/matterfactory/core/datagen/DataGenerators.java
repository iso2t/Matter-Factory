...
import matterfactory.core.datagen.loot.FactoryLootTableProvider;
...
public class DataGenerators {
	...
	public static void gather (@NotNull GatherDataEvent.Client event) {
		...
		// SOUNDS
		pack.addProvider(FactorySoundProvider::new);

		// LOOT TABLES
		pack.addProvider(bindRegistries(FactoryLootTableProvider::new, registries));
