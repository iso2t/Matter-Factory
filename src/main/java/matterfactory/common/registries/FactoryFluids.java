...
public class FactoryFluids {
	...
	// Petroleum
	public static final FluidDefinition CRUDE_OIL   = registerFluid("Crude Oil", 0xFF201812, new Vector3f(0.1F, 0.08F, 0.05F), 920, 3500, true, 0.0F, 0.75F);
	public static final FluidDefinition REFINED_OIL = registerFluid("Refined Oil", 0xFF4D3420, new Vector3f(0.3F, 0.2F, 0.1F), 860, 1200, true, 0.0F, 0.75F);
	...
	public static FluidDefinition registerFluid (String englishName, int tintColor, Vector3f fogColor, int density, int viscosity, boolean opaque, float fogStart, float fogEnd) {
		...
		Supplier<FluidType> type = FactoryFluidTypes.register(baseName, new BaseFluid(englishName, fluidProperties, opaque ? FactoryFluidTypes.OPAQUE_STILL : FactoryFluidTypes.WATER_STILL, opaque ? FactoryFluidTypes.OPAQUE_FLOW : FactoryFluidTypes.WATER_FLOWING, FactoryFluidTypes.WATER_OVERLAY, tintColor, fogColor, opaque, fogStart, fogEnd));
